    ...
    OmnipayPorterAbstract
{
     ...
     * @throws \Exception
     */
    public function newPayflowAuthorizeRequestController(
    ): PayflowAuthorizeRequestController
    {

        // Create the PayflowQueryRequestData entity
        $request_data = new PayflowAuthorizeRequestData(
            'authorize',
            $this->getOffsiteURLs()
        );

        // Return a new PayflowQueryRequestController entity
        return new PayflowAuthorizeRequestController(
     ...
     * @throws \Exception
     */
    public function newPayflowCaptureRequestController(
    ): PayflowCaptureRequestController
    {

        // Create the PayflowQueryRequestData entity
        $request_data = new PayflowCaptureRequestData(
            'capture',
            $this->getOffsiteURLs()
        );

        // Return a new PayflowQueryRequestController entity
        return new PayflowCaptureRequestController(
            $this->getSavedGatewayDataEntity('default'),
            $request_data,
