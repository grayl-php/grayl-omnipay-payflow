 ...
 */
class PayflowAuthorizeRequestControllerTest extends
    TestCase
{
     ...
     * @throws \Exception
     */
    public function testCreatePayflowAuthorizeRequestController(
        ...
        $request = PayflowOrderHelper::getInstance()
            ->newPayflowAuthorizeRequestControllerFromOrder(
                $order_controller,
                $credit_card
            );
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            PayflowAuthorizeRequestController::class,
            $request
        );
     ...
     * @throws \Exception
     */
    public function testSendPayflowAuthorizeRequestController(
        PayflowAuthorizeRequestController $request
    ): PayflowAuthorizeResponseController {
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            PayflowAuthorizeResponseController::class,
            $response
        );
     ...
     * @return string
     */
    public function testPayflowAuthorizeResponseController(
        PayflowAuthorizeResponseController $response
    ): string {
     ...
     * @throws \Exception
     */
    public function testCreateOrderPaymentFromPayflowAuthorizeResponseController(
        OrderController $order_controller,
        PayflowAuthorizeResponseController $response
    ): OrderController {
     ...
     * @throws \Exception
     */
    public function testCreatePayflowCaptureRequestController(
        OrderController $order_controller,
        string $reference_id
        ...
        // Create the object
        $request = PayflowOrderHelper::getInstance()
            ->newPayflowCaptureRequestControllerFromOrder(
                $order_controller,
                $reference_id
            );
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            PayflowCaptureRequestController::class,
            $request
        );
     ...
     * @throws \Exception
     */
    public function testSendPayflowCaptureRequestController(
        PayflowCaptureRequestController $request
    ): PayflowCaptureResponseController {
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            PayflowCaptureResponseController::class,
            $response
        );
     ...
     */
    public function testPayflowCaptureResponseController(
        PayflowCaptureResponseController $response
    ): void {
